    ...
    return (
        <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
                ...
                <h1 className="text-3xl font-bold text-slate-800">Cement Sets (Planks)</h1>

                <p className="text-slate-700 text-lg leading-relaxed">
                    Vertical concrete posts and horizontal planks manufactured using prestress technology
                    with designed concrete mixes to achieve maximum durability and strength.
                </p>
                ...
                <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-2 font-mono text-sm">
                    <div className="flex justify-between border-b border-slate-200 pb-2">
                        ...
                        <span className="text-slate-800 font-semibold">6 Feet (1828.8 mm)</span>
                    </div>
                    <div className="flex justify-between border-b border-slate-200 pb-2">
                        <span className="text-slate-700">Height:</span>
                        <span className="text-slate-800 font-semibold">1 Foot (300 mm)</span>
                    </div>
                    <div className="flex justify-between border-b border-slate-200 pb-2">
                        <span className="text-slate-700">Width / Thickness:</span>
                        <span className="text-slate-800 font-semibold">2 Inches (50 mm)</span>
                    </div>
